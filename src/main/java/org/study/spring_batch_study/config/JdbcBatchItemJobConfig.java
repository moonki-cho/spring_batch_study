...
import org.study.spring_batch_study.provider.CustomerItemSqlParameterSourceProvider;
...
public class JdbcBatchItemJobConfig {
    ...
    public Step flatFileStep(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
        log.info("------------------ Init jdbcBatchItemStep -----------------");

        return new StepBuilder("jdbcBatchItemStep", jobRepository)
    ...
    public Job flatFileJob(Step flatFileStep, JobRepository jobRepository) {
        log.info("------------------ Init jdbcBatchItemJob -----------------");
